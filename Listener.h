#ifndef ORDEREVENTLISTENER_LISTENER_H
#define ORDEREVENTLISTENER_LISTENER_H
...
namespace ordproc{
    ...
    public:
        ...
        // * 'OnOrderRequestAcknowledged', in which case order 'id' is active in the market;
        //        or
...
#endif //ORDEREVENTLISTENER_LISTENER_H
